...
if __name__ == "__main__":
    ...
    emb_folders = ['data/embeddings/dbbook/graph/',
                'data/embeddings/dbbook/text/',
                'data/embeddings/dbbook/images/',
                ]
    ...
    source_features = dict(sorted((pkl.load(open('data/embeddings/dbbook/graph/compgcn_384_n1.pkl', 'rb'))).items()))
    ...
    feature_list = [ ['compgcn_384_n1', 'all-MiniLM-L12-v2_dictionary', 'vit_cls'] ]
    getall_models = [GETAllNetworkTriSelfSourcesCross]    
    dropout_values = [ 0.6 ]
    setting_names = []
    setting_sources = ['uni', 'double', 'tri']
